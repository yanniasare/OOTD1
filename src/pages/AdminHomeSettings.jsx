    ...
    <AdminLayout activeTab="settings">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Home Page Settings</h1>
          <div className="flex items-center gap-2">
            <button onClick={onReset} className="px-3 py-2 rounded-md bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">Reset</button>
            <button onClick={onSave} className="px-3 py-2 rounded-md bg-black text-white hover:bg-gray-800 transition-colors">Save</button>
          </div>
        </div>
